...
<body>  
    ...
    <section class="destinations">  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$25–$30 per dish.</p>  
            <p><strong>⏳ Tip:</strong> Expect long lines—arrive early or book in advance.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$25 for a sunset boat tour.</p>  
            <p><strong>⏳ Tip:</strong> Go on a night snorkeling tour to see the glowing effect best.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> Free entry (drinks ~$5).</p>  
            <p><strong>⏳ Tip:</strong> The biggest parties happen every full moon—check the schedule before going!</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$3 entry.</p>  
            <p><strong>⏳ Tip:</strong> Visit early in the morning to avoid crowds.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$3 entry.</p>  
            <p><strong>⏳ Tip:</strong> Requires a short but steep hike, so wear comfortable shoes.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$40 for a guided tour.</p>  
            <p><strong>⏳ Tip:</strong> Try the "Hong by Starlight" tour to see the caves glowing at night!</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$10 entry.</p>  
            <p><strong>⏳ Tip:</strong> The higher levels are less crowded and more beautiful—hike all the way up!</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$40–$100 per night (includes meals).</p>  
            <p><strong>⏳ Tip:</strong> Wake up early for a boat safari to see wild elephants and gibbons.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$30–$60 for ringside seats.</p>  
            <p><strong>⏳ Tip:</strong> The best fights happen on weekends—check the schedule!</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> Officially closed, but some guides offer access (~$10–$20).</p>  
            <p><strong>⏳ Tip:</strong> Be cautious—it's not officially open to the public!</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$100–$150 for a dive trip.</p>  
            <p><strong>⏳ Tip:</strong> The best time to see whale sharks is February to May.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$1 train ride, museum entry ~$5.</p>  
            <p><strong>⏳ Tip:</strong> Take the slow train for the best views over the cliffs.</p>  
        </div>  
        ...
        <div class="destination">  
            ...
            <p><strong>💰 Cost:</strong> ~$150–$200 per person.</p>  
            <p><strong>⏳ Tip:</strong> The best time for balloon rides is November to February (cooler weather).</p>  
        </div>  
    </section>  
